...

{
  ...
  __libc_start_main(main, unaff_retaddr, &stack0x00000008, __libc_csu_init,
                    __libc_csu_fini, param_3, auStack_8);
  do
  {
...

{
  ...
  while (bVar1)
  {
    ...
    if ((cyclesToRun == 0) ||
        (((bVar3 && (quantumCount == 0)) || (interruptFound))))
    {
      bVar1 = false;
    }
  }
...

{
       ...
       local_10 = local_10->nextNode)
  {
    ...
    printf("/op end time: %8.6f", local_10->opEndTime);
    puts("\n");
  }
  return;
}
...

{
  ...
  numBuffer = 0;
  local_30 = 4;
  cmdBuffer = auStack_b8;
  local_40 = 0xe;
  argStrBuffer = auStack_c8;
...

{
  ...
  *configData = (ConfigDataType *)0x0;
  ...
  {
    _Var1 = getStringToDelimiter((FILE *)inStream, ':', dataBuffer);
    if ((_Var1) && (iVar2 = compareString(dataBuffer,
                    ...
                    iVar2 == 0))
    {
      ...
      while (true)
      {
        ...
        {
          _Var1 = getStringToDelimiter((FILE *)inStream, '.', dataBuffer);
          if ((_Var1) && (iVar2 = compareString(
                              dataBuffer, "End Simulator Configuration File"),
                          iVar2 == 0))
          {
...

{
  ...
  *capturedString = '\0';
  ...
  while ((intChar != -1 && (((clearLeadingNonPrintable && (intChar < 0x20)) ||
                             ((clearLeadingSpace && (intChar == 0x20)))))))
  {
    intChar = fgetc((FILE *)inStream);
  }
  if (intChar == -1)
  ...
  else
  {
    while ((((intChar != -1 && (index < 0x7f)) &&
             (((stopAtNonPrintable && (0x1f < intChar)) ||
               (!stopAtNonPrintable)))) &&
            (delimiter != intChar)))
    {
...

{
  ...
  dVar1 = uSecDiff / 1000000.0 + secDiff;
  sprintf(timeStr, "%9.6f", dVar1);
  return dVar1;
}
