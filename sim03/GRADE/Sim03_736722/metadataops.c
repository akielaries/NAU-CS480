...
Device Input/device: none
Device Output/device: none
Dependencies: free, clearMetaDataList
*/
...
Function Output/Parameters: pointer to head
...
/*
Name: getCommand
Process: parses three leter command part of op code string
...
Dependencies: copyString, fopen, getStringToDelimiter, compareString, fclose,
              malloc, getOpCommand, updataStartCount, updateEndCount,
...
Function Output/Parameters: none
Function Output/Returned: update count, if "end" string found,
                          otherwise no change
Device Input/device: none
Device Output/device: none
...
Function Output/Parameters: none
Function Output/Returned: update count, if "start" string found,
                          otherwise no change
Device Input/device: none
Device Output/device: none
Dependencies: compareString
