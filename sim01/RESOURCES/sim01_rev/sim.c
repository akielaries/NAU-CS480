...

{
  ...
  __libc_start_main(main, in_stack_00000000, &stack0x00000008, __libc_csu_init,
                    __libc_csu_fini, param_3, auStack8);
  do
  {
...

{
  ...
  else
  {
    ...
    {
      _Var1 = getMetaData(configDataPtr->metaDataFileName, &metaDataPtr,
                          errorMessage);
      if (_Var1 == false)
      {
      ...
      if (wkgOpListPtr->opEndTime < dVar2)
      {
        if (pPVar1->state != 4)
        {
          sprintf(reportString,
                  ...
                  "operation",
                  (ulong)(uint)wkgOpListPtr->pid, wkgOpListPtr->strArg1,
                  wkgOpListPtr->inOutArg);
  ...
  do
  {
    ...
    else
    {
      ...
      else
      {
        iVar4 = compareString(wkgOpCode->command, "app");
        if ((iVar4 == 0) &&
            (iVar4 = compareString(wkgOpCode->strArg1, "end"), iVar4 == 0))
        {
            ...
            else
            {
              ...
              if (iVar4 == 0)
              {
                sprintf(reportString, "Process: %d, %s %s operation start",
                        (ulong)(uint)wkgOpCode->pid, wkgOpCode->command,
                        wkgOpCode->strArg1);
                runSimReport(1, configPtr, reportString);
...

{
  ...
  if ((iVar1 == 0) &&
      (iVar1 = compareString(metaDataMstrPtr->strArg1, "start"), iVar1 == 0))
  {
                ...
                (iVar1 = compareString(local_48->strArg1, "end"), iVar1 != 0)))
    {
      ...
      if ((iVar1 == 0) &&
          (iVar1 = compareString(local_48->strArg1, "start"), iVar1 == 0))
      {
        ...
        while ((iVar1 = compareString(local_48->command, "app"),
                iVar1 != 0 || (iVar1 = compareString(local_48->strArg1, "end"),
                               iVar1 != 0)))
        {
...

{
  ...
  if (displayFlag != false)
  {
    ...
    for (; wkgMemPtr != (MemNodeType *)0x0; wkgMemPtr = wkgMemPtr->nextNode)
    {
      ...
      {
        printf("%d [ %s, P#: x, ", (ulong)(uint)wkgMemPtr->physicalStart,
               dispString);
      }
      else
      {
        printf("%d [ %s, P#: %d, ", (ulong)(uint)wkgMemPtr->physicalStart,
               dispString, (ulong)(uint)wkgMemPtr->processNumber);
      }
...

{
  ...
  else
  {
    ...
    if ((iVar3 == 0) ||
        (iVar3 = compareString(opCodePtr->strArg1, "clearOne"), iVar3 == 0))
    {
      logicalLow = 1;
      logicalOffset = 1;
    }
    ...
    if (((iVar4 == 0) ||
         (iVar4 = compareString(opCodePtr->strArg1, "access"), iVar4 == 0)) &&
        ((logicalLow < 0 ||
    ...
    else
    {
      ...
      if (iVar4 == 0)
      {
        for (wkgMemPtr = processMemRequest::memHeadPtr;
             wkgMemPtr != (MemNodeType *)0x0; wkgMemPtr = wkgMemPtr->nextNode)
        {
        ...
        if (wkgMemPtr != (MemNodeType *)0x0)
        {
              ...
              logicalOffset)
          {
            ...
            pMVar5 = createNewMemNode(wkgMemPtr->physicalStart, iVar4 + -1, 2,
                                      procNum, logicalLow, iVar3);
            pMVar1 = pMVar5;
          ...
          reuseMemNode(wkgMemPtr, 2, procNum, wkgMemPtr->physicalStart,
        ...
        if (iVar4 != 0)
        {
          ...
          if (iVar3 == 0)
          {
                 ...
                 wkgMemPtr = wkgMemPtr->nextNode)
            {
              if (wkgMemPtr->processNumber == procNum)
              {
                reuseMemNode(wkgMemPtr, 1, -1, wkgMemPtr->physicalStart,
                             wkgMemPtr->physicalStop, 0, 0);
              }
            }
            defragMemory(processMemRequest::memHeadPtr);
            sprintf(displayStr, "After clear process %d success",
                    (ulong)procNum);
            diagMemDump(processMemRequest::memHeadPtr, displayStr, _Var2);
            return true;
          }
...

{
  ...
  while (bVar1)
  {
    ...
    if ((cyclesToRun == 0) ||
        (((bVar3 && (quantumCount == 0)) || (interruptFound != false))))
    {
      bVar1 = false;
    }
  }
...

{
  ...
  while (interruptFound != true)
  {
    runTimer(milliSeconds);
    interruptFound =
        processIntRequest(CHECK_FOR_INTERRUPT, (OpCodeType *)0x0, pcbListPtr);
  }
  reportString._0_8_ = 0x20555043203a534f;
...

{
  ...
  *opCodeDataHead = (OpCodeType *)0x0;
  ...
  else
  {
    ...
    if ((_Var1 == true) &&
        (iVar2 = compareString(dataBuffer, "Start Program Meta-Data Code"),
         iVar2 == 0))
    {
      ...
      if (accessResult == COMPLETE_OPCMD_FOUND_MSG)
      {
        ...
        if (accessResult == 8)
        {
          ...
          _Var1 = getStringToDelimiter((FILE *)inStream, '.', dataBuffer);
          if ((_Var1 != true) ||
              (iVar2 = compareString(dataBuffer, "End Program Meta-Data Code"),
               iVar2 != 0))
          {
            accessResult = 2;
  ...
  if (((((iVar1 != 0) &&
       ...
       ((((iVar1 = compareString(strArg, "ethernet"),
          ...
          ((iVar1 = compareString(strArg, "keyboard"),
            iVar1 != 0 &&
                ((iVar1 = compareString(strArg, "monitor"),
                  iVar1 != 0 && (iVar1 = compareString(strArg, "printer"),
                                 iVar1 != 0)))))) &&
...

{
  ...
  if ((((iVar1 != 0) && (iVar1 = compareString(testCmd, "app"), iVar1 != 0)) &&
      ...
      ((iVar1 = compareString(testCmd, "mem"),
        iVar1 != 0 && (iVar1 = compareString(testCmd, "dev"), iVar1 != 0))))
  {
    return false;
  }
  return true;
  ...
  else
  {
         ...
         iVar2 == 0))
    {
      ...
      while (true)
      {
        ...
        _Var1 =
            valueInRange(lineCode, intData, doubleData, lowerCaseDataBuffer);
        if (_Var1 == false)
        {
          free(__ptr);
          fclose(inStream);
...

{
  ...
  case 6:
    ...
    if ((((iVar1 != 0) &&
          (iVar1 = compareString(lowerCaseStringVal, "sjf-n"), iVar1 != 0)) &&
  ...
  case 0xc:
    ...
    if (((iVar1 != 0) &&
         (iVar1 = compareString(lowerCaseStringVal, "monitor"), iVar1 != 0)) &&
...

{
  ...
  for (index = 0;
       ((oneStr[index] != '\0' && (otherStr[index] != '\0')) && (index < 0x80));
       index = index + 1)
  {
...

{
  ...
  _Var1 =
      getStringConstrained(inStream, true, true, true, '\x7f', capturedString);
  return _Var1;
}
...

{
  ...
  if ((controlCode == 1) && (accessTimer::running != false))
  {
    ...
    fpTime = processTime(
        (double)accessTimer::startSec, (double)(int)lapData.tv_sec,
  ...
  else if ((controlCode == 2) && (accessTimer::running != false))
  {
    ...
    fpTime = processTime(
        (double)accessTimer::startSec, (double)(int)endData.tv_sec,
